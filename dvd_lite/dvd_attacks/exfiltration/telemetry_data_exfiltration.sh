#!/bin/bash
# 샘플 exfiltration 공격 스크립트: telemetry_data_exfiltration.sh
# 자동 생성된 테스트용 스크립트

echo "🎯 exfiltration 공격 시작: telemetry_data_exfiltration.sh"
echo "⏱️ 시작 시간: $(date)"
...
echo "TECHNIQUE:exfiltration" >> "$IOC_FILE"
...
echo "✅ telemetry_data_exfiltration.sh 공격 완료"
