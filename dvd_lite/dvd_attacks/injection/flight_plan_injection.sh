#!/bin/bash
# 샘플 injection 공격 스크립트: flight_plan_injection.sh
# 자동 생성된 테스트용 스크립트

echo "🎯 injection 공격 시작: flight_plan_injection.sh"
echo "⏱️ 시작 시간: $(date)"
...
echo "TECHNIQUE:injection" >> "$IOC_FILE"
...
echo "✅ flight_plan_injection.sh 공격 완료"
