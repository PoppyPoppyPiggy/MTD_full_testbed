#!/bin/bash
# 샘플 denial_of_service 공격 스크립트: mavlink_flood.sh
# 자동 생성된 테스트용 스크립트

echo "🎯 denial_of_service 공격 시작: mavlink_flood.sh"
echo "⏱️ 시작 시간: $(date)"
...
echo "TECHNIQUE:denial_of_service" >> "$IOC_FILE"
