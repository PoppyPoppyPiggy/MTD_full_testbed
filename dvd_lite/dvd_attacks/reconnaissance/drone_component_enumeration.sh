#!/bin/bash
# 샘플 reconnaissance 공격 스크립트: drone_component_enumeration.sh
# 자동 생성된 테스트용 스크립트

echo "🎯 reconnaissance 공격 시작: drone_component_enumeration.sh"
echo "⏱️ 시작 시간: $(date)"
...
echo "TECHNIQUE:reconnaissance" >> "$IOC_FILE"
...
echo "✅ drone_component_enumeration.sh 공격 완료"
